...
Role:
You are the PROPONENT. Your job is to argue in favor of a candidate answer to the question.
...
Role:
You are the PROPONENT. You must argue in favor of your candidate answer.
...
5. Be persuasive but do not knowingly fabricate facts.

Important:
- Use the full prior transcript as context.
- Focus on the strongest reasons your answer is correct.
- Address weaknesses or ambiguities raised by Debater B.
...
"""
    ...
    def direct_answer(self, question: str, temperature: float = 0.2) -> dict:
        ...
        Not part of the debate protocol itself, but useful for experiments.
...
"""
    ...
    def _format_transcript(self, transcript: list) -> str:
        """
        Format the debate transcript so Debater A can use all previous rounds as context.
        """
